...
export function ProfileSettings({ initialData }: ProfileSettingsProps) {
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateAdminProfile(user?.email || 'vel@proultimaengineering.com', profileData);
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateAdminPassword(user?.email || 'vel@proultimaengineering.com', {
