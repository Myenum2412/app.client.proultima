...
interface AllTransactionsPDFReportProps {
...
export function AllTransactionsPDFReport({
  transactions,
  includeSummary = true,
  includeBalances = true,
}: AllTransactionsPDFReportProps) {
  // Calculate summary
  const summary = {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.companySubtitle}>Complete Cash Transaction Report</Text>
          </View>
          <View>
        ...
        <View style={styles.reportHeader}>
          <Text style={styles.reportTitle}>All Transactions Report</Text>
          ...
          <Text style={styles.reportSubtitle}>
            All Branches - Complete Cashbook History
          </Text>
        </View>
        ...
        {transactions.length > 0 ? (
          <View style={styles.transactionTable}>
            ...
            <View style={styles.tableHeader}>
              ...
              <Text style={[styles.tableHeaderCell, { width: '10%' }]}>Voucher</Text>
              <Text style={[styles.tableHeaderCell, { width: '12%' }]}>Branch</Text>
              <Text style={[styles.tableHeaderCell, { width: '15%' }]}>Staff</Text>
              ...
              <Text style={[styles.tableHeaderCell, { width: '12%' }]}>Balance</Text>
            </View>
            ...
            {transactions.map((transaction, index) => (
              <View key={transaction.id} style={styles.tableRow}>
                ...
                <Text style={[styles.tableCellLeft, { width: '15%' }]}>
                  {transaction.primary_list.length > 18 
                    ? `${transaction.primary_list.substring(0, 18)}...`
                ...
                <Text style={[styles.tableCell, styles.amountCell, styles.balanceAmount, { width: '12%' }]}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            PROULTIMA - Complete Cash Transaction Report
          </Text>
          <Text style={styles.generatedText}>
