...
interface PurchaseRequisitionDrawerProps {
  isOpen: boolean;
...
export function PurchaseRequisitionDrawer({
  isOpen,
  onOpenChange,
  onSubmit,
  isSubmitting = false
}: PurchaseRequisitionDrawerProps) {
  const { user } = useAuth();
    ...
    <Drawer open={isOpen} onOpenChange={onOpenChange}>
      <DrawerContent className="max-h-[90vh] max-w-2xl mx-auto">
        <DrawerHeader className="border-b">
          <DrawerTitle>Buy Product - Purchase Requisition</DrawerTitle>
          <DrawerDescription>
