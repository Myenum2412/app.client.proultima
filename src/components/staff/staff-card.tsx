...
export function StaffCard({ employee, onEdit, onDelete, isDeleting }: StaffCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/20">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <Avatar className="relative w-16 h-16 border-4 border-background rounded-2xl transition-transform duration-300 group-hover:scale-110">
