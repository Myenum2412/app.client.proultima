...
export function TeamFormDialog({
  ...
  // Debug logging
  useEffect(() => {
    // console.log('🔍 Team Form Dialog - Branch Debug:', {
    //   branches,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {!branches ? (
                ...
                <div className="flex h-10 w-full items-center justify-center rounded-md border border-orange-200 bg-orange-50 px-3 py-2 text-sm text-orange-600">
                  No branches configured. Go to Settings to add branches.
                </div>
              ) : (
                <Select
